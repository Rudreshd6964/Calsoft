...
@Component({
  selector: 'app-spreadsheet-v1',
  templateUrl: './spreadsheet-v1.component.html',
  styleUrls: ['./spreadsheet-v1.component.css']
})
export class SpreadsheetV1Component implements OnInit {
